...
|장점|어떤 플랫폼에서도 이용 가능|네트웨크가 없어도 이용 가능/프로세싱 성능이 높음|
|단점|네트웨크가 필수/성능이 낮음|플랫폼 마다 개발이 필수|
...
![웹서버동작원리](./img/https://github.com/gyuhyeok2/ex2/blob/master/img/web-01-fig1.jpg)
